...
- `cyberbrain/tenancy/` now includes trusted-identity/enforcement/quota/readiness domain foundations while current shared runtime remains fail-closed outside `single_owner`; broader search/write enforcement and persisted tenant/user identity remain pending;
