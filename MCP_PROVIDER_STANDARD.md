...
> Status: Draft v0.1
> Scope: Internal MCP providers integrated with SlncTrZ-MCP
...
3. **Self-describing** — every provider exposes a mandatory `.help` tool.
...
SlncTrZ-MCP canonicalizes them into:
...
Canonical namespace ownership belongs to SlncTrZ-MCP.

---

## 6. Mandatory `.help` Tool

Every provider MUST expose a zero-side-effect help tool.
